...
const Premium = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-75 flex items-start sm:items-center justify-center p-2 sm:p-4">
            <div ref={modalRef} className="w-full max-w-6xl transform overflow-hidden rounded-2xl bg-black p-4 sm:p-6 text-left align-middle shadow-xl mt-8 sm:mt-0">
                <div className="relative">
                    <button
                        onClick={onClose}
                        className="absolute -right-1 -top-1 text-[#B8860B] hover:text-[#B8860B]/80 p-2"
                    >
                    ...
                    <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-[#B8860B] mb-4 sm:mb-8 mt-8 sm:mt-4 px-8">
                        NEW MEMBERSHIP PACKAGES
                    </h3>

                    <div className="text-lg sm:text-xl text-center text-[#B8860B]/90 mb-6 sm:mb-12 px-4">
                        <p className="mb-1">Worrying about exceeding kilometer?</p>
                        <p>Try our new packages that convenient for you!</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 px-2">
                        {/* Silver Package */}
                    ...
                    <div className="mt-6 sm:mt-8 text-center text-[#B8860B]/80 px-2">
